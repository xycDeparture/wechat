...
import ReplyCheckComp from 'wechat/components/reply/check'
import { fetchReplyList, fetchReplyById } from 'wechat/actions'
...
@connect(
    ...
    dispatch => ({
        actions: bindActionCreators({ fetchReplyList, fetchReplyById }, dispatch)
    })
)
